...
class WaveTransitionPanelViewModel extends UiViewModel {
  ...
  @property() public itemDesNeg1: string = "";
  ...
  @property() public itemDesNeg2: string = "";
  ...
  @property() public itemDesNeg3: string = "";
}
...
export class WaveTransitionPanel extends BasePanel<WaveTransitionPanelViewModel> {
  ...
  private getPlayerHP(): Maybe<HealthComponent> {
    return this.playerEntity?.getComponent(Player)?.getHealth() ?? null;
  }
  ...
  public showCase(): void {
    ...
    for (let i = 0; i < picked.length; i++) {
      ...
      const itemDesNegative = item.getDescriptionNegative();
      ...
      if (i === 0) {
        ...
        this.viewModel.itemDesNeg1 = itemDesNegative;
        ...
        this.viewModel.itemDesNeg2 = itemDesNegative;
        ...
        this.viewModel.itemDesNeg3 = itemDesNegative;
  ...
  private optional(item: UpgradeItem): void {
    ...
    switch (item.getId()) {
      case 0: {
        ...
        // tripleItem?.setCanBuy(true);  Tạm thời không cho mua item này
      ...
      case 14: {
        ...
        hp?.heal(hp.getMax() * 0.2);
        break;
      }
      case 15: {
        const hp = this.getPlayerHP();
        hp?.heal(hp.getMax() * 0.4);
        break;
      }
    }
  }
