...
export class UpgradeItem {
  ...
  @property() private descriptionNegative: string = "";

  @property() private statNegative: number = Stat.MoveSpeed;
  @property() private valueNegative: number = 0;
  @property() private percentValueNegative: number = 0;
  ...
  public getDescriptionNegative(): string { return this.descriptionNegative; }
  public getStatNegative(): number { return this.statNegative; }
  public getValueNegative(): number { return this.valueNegative; }
  public getPercentValueNegative(): number { return this.percentValueNegative; }
}
